...
description: Connecting S0 to WiFi in Access Point or Station Mode
---

# Connecting S0 to WiFi

Since S0 is based on ESP32-C6 which has WiFi capabilities, it can be configured in Station Mode or Access Point Mode.
...
To configure S0 in station mode, configure the WiFi SSID and password in `src/config.h`:
