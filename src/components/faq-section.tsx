...
const faqs = [
  {
    question: "What is the A0 Gateway?",
    answer:
      "The A0 Gateway is a modular, Zephyr-based IoT gateway combining the A0 Board with the Baseboard. It provides multi-protocol connectivity (Wireless M-Bus, NB-IoT, LTE-M, WiFi, BLE) for smart metering, industrial IoT, and edge computing applications. Running Zephyr RTOS on an ESP32-C6 RISC-V core, A0 is optimised for low-power, constrained environments.",
  },
  {
    question: "What is the A1 Gateway?",
    answer:
      "The A1 Gateway is a Linux-based IoT gateway that combines the A0 Board with the BeagleV-Fire board. Unlike A0, which runs Zephyr RTOS, A1 runs a full Linux operating system on RISC-V architecture. This makes it ideal for applications that require advanced processing power, containerised workloads, edge AI inference, or richer software stacks not available on a bare-metal RTOS.",
  },
  {
    question: "What is the difference between A0 and A1?",
    answer:
      "A0 is a Zephyr-based gateway built from the A0 Board and the Baseboard — designed for low-power, constrained IoT deployments. A1 is a Linux-based gateway built from the A0 Board and the BeagleV-Fire — designed for industrial IoT workloads that demand a full Linux OS, greater compute power, and edge-to-cloud integration. Both gateways share the same A0 Board and its multi-protocol wireless capabilities.",
  },
  {
    question: "Is A1 a standalone gateway?",
    answer:
      "Yes. A1 is a complete, standalone Linux-based IoT gateway. It combines the A0 module's multi-protocol wireless connectivity (Wireless M-Bus, NB-IoT, LTE-M, WiFi, BLE) with the BeagleV-Fire's Linux compute capabilities. You do not need a separate gateway — A1 handles both edge processing and cloud connectivity on its own.",
  },
  {
    question: "What wireless protocols are supported?",
    answer:
      "Both A0 and A1 gateways support multiple wireless protocols via the A0 module: Wireless M-Bus (868 MHz) for smart metering, Bluetooth LE for short-range device connectivity, WiFi for high-bandwidth applications, and cellular (LTE-M/NB-IoT) for wide-area coverage. Multiple protocols can be active simultaneously for hybrid deployments.",
  },
  {
